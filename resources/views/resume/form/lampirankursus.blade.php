<div id="per-vertical" class="content">
    <div class="content-header">
        <h5 class="mb-0">Lampiran 1 -Kursus dan Seminar yang dihadiri
            <br>
            (Bagi 3 tahun terkini, contoh : Konvensyen Pembangunan dan Kesejahteraan Rakyat 2023 "Pembangunan Madani, Rakyat Disantuni")
        </h5>
    </div>
    <div class="row">
