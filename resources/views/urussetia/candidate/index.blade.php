...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Senarai Calon Naik Pangkat</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Senarai Calon Naik Pangkat</a>
                        </li>
                    </ol>
                </div>
            </div>
...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <table class="datatables table table-candidate">
                    <thead>
                        <tr>
                            <th>nokp</th>
                            <th>nama</th>
                            <th>jawatan</th>
                            <th>Gred Pemangkuan</th>
                            <th>Tempoh Pemangkuan</th>
                            <th>tindakan</th>
                        </tr>
                    </thead>
                </table>
...
<script src="{{asset('local/candidate/js/setting.js')}}"></script>
<script src="{{asset('local/candidate/js/controller.js')}}"></script>
<script src="{{asset('local/candidate/js/main.js')}}"></script>
@endsection
