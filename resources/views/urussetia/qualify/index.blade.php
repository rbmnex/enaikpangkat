...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Senarai Calon Berjaya</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Senarai Calon Berjaya</a>
                        </li>
                    </ol>
                </div>
            </div>
...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <table class="datatables table table-qualify">
                    <thead>
                        <tr>
                            <th></th>
                            <th>nokp</th>
...
<script src="{{asset('local/qualify/js/page_setting.js')}}"></script>
<script src="{{asset('local/qualify/js/index.js')}}"></script>
@endsection
