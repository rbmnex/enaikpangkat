<div id="cuti-vertical" class="content">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <select class="select2 " name="cuti_status" id="country">
        ...
        <div class="form-group col-md-12">
            <br/>
            <button type="button" class="btn btn-success tambah-calon" data-toggle="modal" data-target="#modal-cuti"><i data-feather='plus'></i>Tambah</button>
        </div>
