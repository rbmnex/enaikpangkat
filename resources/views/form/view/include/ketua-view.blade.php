        ...
        <div class="card-body">
            <div class="form-group col-md-12">
                <div class="form-check form-check-inline ">
                    <input type="radio" value="1" class="form-check-input medium radio-certified" name="terima_tawaran" onclick="return false;" id="radiol-1" @if($pemohon->perakuan_ketua_jabatan == 1) checked @endif/>
                    <label class="col-form-label" for="tatatertib"> Diperaku</label>
                </div>
                <div class="form-check form-check-inline ">
                    <input type="radio" value="0" class="form-check-input medium radio-certified" name="terima_tawaran" onclick="return false;" id="radiol-2" @if(!empty($pemohon->perakuan_ketua_jabatan) && $pemohon->perakuan_ketua_jabatan == 0) checked @endif/>
                ...
                <div class="form-group col-12">
                    ...
                    <textarea row=3 readonly type="text" width="100%" id="ulasan_ketua" class="form-control ulasan_ketua" name="ulasan_ketua"  placeholder="Sila Berikan Ulasan Anda">{{ empty($pemohon->perakuan_ketua_jabatan_ulasan) ? '' : $pemohon->perakuan_ketua_jabatan_ulasan }}</textarea>
                    <div class="invalid-feedback"></div>
                </div>
            ...
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="tkh-ketua" readonly class="form-control tkh-ketua" placeholder="" value="{{ empty($pemohon->perakuan_ketua_jabatan_tkh) ? '' : \Carbon\Carbon::parse($pemohon->perakuan_ketua_jabatan_tkh)->format('d-m-Y') }}">
                    </div>
                </div>
            </div>
        </div>
