            ...
            <div class="card">
                <div class="card-header"></div>
                  <div class="card-body">
                        ...
                        <p>Tuan/Puan,</p>
                        <p><strong>PERKARA : PERAKUAN KETUA JABATAN UNTUK URUSAN NAIK PANGKAT</strong></p>
                        <p>Pegawai bernama {{ $nama }}, {{ $jawatan }} {{ $gred }} dengan nombor kad pengenalan {{ $nokp }} ingin mendapatkan perakuan dari pihak tuan/puan untuk urusan pemangkuan.</p>
