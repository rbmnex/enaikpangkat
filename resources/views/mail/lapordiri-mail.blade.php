            ...
            <div class="card">
                <div class="card-header"></div>
                  <div class="card-body">
                        ...
                        <p>Tuan/Puan,</p>
                        <p><strong>PERKARA : LAPOR DIRI UNTUK PEMANGKUAN</strong></p>
                        <p>Sukacita dimaklumkan anda telah dipilih untuk melanjutkan pemangkuan ini</p>
                        <p>Sila gunakan pautan link dibawah ini untuk memulakan proses lapor diri:</p>
