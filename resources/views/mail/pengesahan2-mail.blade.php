            ...
            <div class="card">
                <div class="card-header"></div>
                  <div class="card-body">
                        ...
                        <p>Tuan/Puan,</p>
                        <p><strong>PERKARA : PENGESAHAN PERKHIDMATAN PEGAWAI UNTUK URUSAN NAIK PANGKAT</strong></p>
                        <p>Pegawai bernama {{ $nama }} berjawatan {{ $jawatan }} {{ $gred }} dengan nombor kad pengenalan {{ $nokp }} ingin mendapatkan Pengesahan Perkhidmatan Pegawai dari pihak Tuan/Puan untuk urusan pemangkuan.</p>
