    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Senarai Soalan</h2>
...
@section('customJs')
    ...
    <script src="{{ asset('app_js_helper/segment/bpsm/settings.js') }}"></script>
    <script src="{{ asset('app_js_helper/segment/bpsm/controller.js') }}"></script>
    <script src="{{ asset('app_js_helper/segment/bpsm/main.js') }}"></script>
@endsection
