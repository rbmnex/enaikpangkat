...
class Ukp12Pdf extends Fpdf {
    ...
    function butirPeribadi($input = array()) {
        ...
        $this->Ln(3);
        $this->Cell(0,10,' Pengesahan * Cuti Tanpa Gaji / Cuti Separuh Gaji / Cuti Belajar Sepanjang Pekhidmatan','LR',0,'L');
        $this->Ln(10);
        ...
        $this->Ln(5);
        $this->SetFont('Arial','',10);
        $this->Cell(15,10,'','L',0,'L');
        $this->Cell(50,10,'Cuti Tanpa Gaji','RL',0,'L');
        $this->Cell(30,10,'','R',0,'L');
        $this->Cell(30,10,'','R',0,'L');
        $this->Cell(0,10,'','R',0,'L');
        $this->Ln(10);
        $this->Cell(15,10,'','L',0,'L');
        $this->Cell(50,10,'','BRL',0,'L');
        $this->Cell(30,10,'','RB',0,'L');
        $this->Cell(30,10,'','RB',0,'L');
        $this->Cell(0,10,'','R',0,'C');
        $this->Ln(10);
        $this->Cell(15,10,'','L',0,'L');
        $this->Cell(50,10,'Cuti Separuh Gaji','RL',0,'L');
        $this->Cell(30,10,'','R',0,'L');
        $this->Cell(30,10,'','R',0,'L');
        $this->Cell(0,10,'','R',0,'C');
        $this->Ln(10);
        ...
        $this->Ln(10);
        $this->Cell(15,10,'','L',0,'L');
        $this->Cell(50,10,'Cuti Belajar Bergaji Penuh','RL',0,'L');
        $this->Cell(30,10,'','R',0,'L');
        $this->Cell(30,10,'','R',0,'L');
        $this->Cell(0,10,'','R',0,'C');
        $this->Ln(10);
        $this->Cell(15,10,'','L',0,'L');
        $this->Cell(50,10,'/ Cuti Belajar Separuh Gaji','BRL',0,'L');
        $this->Cell(30,10,'','RB',0,'L');
        $this->Cell(30,10,'','RB',0,'L');
        $this->Cell(0,10,'','R',0,'C');
        $this->Ln(10);
        $this->Cell(0,10,'','RL',0,'C');
        $this->Ln(10);
        $this->SetFont('Arial','BI',10);
        $this->Cell(0,5,' * Surat Kelulusan Cuti yang disahkan perlu diserta bersama','RL',0,'L');
        $this->Ln(5);
        $this->Cell(0,25,'','RLB',0,'C');
    }
